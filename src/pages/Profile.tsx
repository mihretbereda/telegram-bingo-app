...
export default function Profile() {
  ...
  const stats = [
    { icon: <Trophy   size={20} color="#f5a623" />, label: "Games Won",     value: "0", accent: "#f5a623" },
    { icon: <Users    size={20} color="#4a90d9" />, label: "Total Invites", value: "0", accent: "#4a90d9" },
    { icon: <TrendingUp size={20} color="#00c853" />, label: "Total Earned", value: "0 ETB", accent: "#00c853" },
  ];
...
function ToggleRow({
  icon, label, accent, checked, onChange,
}: {
  ...
  return (
    <div style={styles.settingRow}>
      <div style={{ ...styles.settingIcon, background: `${accent}18`, color: accent }}>
        {icon}
      </div>
      ...
      <button
        ...
        style={{
          ...styles.toggle,
          background: checked ? "var(--accent-orange)" : "rgba(255,255,255,0.15)",
...
const styles: Record<string, React.CSSProperties> = {
  ...
  avatarRing: {
    padding: "3px",
    borderRadius: "50%",
    background: "linear-gradient(135deg, #f5a623, #4a90d9)",
    marginBottom: "4px",
  },
  avatar: {
    width: "80px",
    height: "80px",
    borderRadius: "50%",
    background: "linear-gradient(135deg, #2d2060, #1a1040)",
