...
const s: Record<string, React.CSSProperties> = {
  ...
  cellSel:   { background: "rgba(0,200,83,0.55)", border: "1.5px solid #00c853", color: "#fff", fontWeight: 800 },
  cellTaken: { background: "rgba(255,72,66,0.45)", border: "1.5px solid #ff4842", color: "#fff", fontWeight: 700, cursor: "not-allowed" },
